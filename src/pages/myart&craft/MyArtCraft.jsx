...
function MyArtCraft() {
  ...
  return (
    <>
      ...
      {/* my art & craft */}
      <div className="my-4 md:my-6 lg:my-8 grid grid-cols-4 justify-between gap-4 md:gap-6 ">
        <div className="relative m-10 w-full max-w-xs overflow-hidden rounded-lg bg-white shadow-md">
          ...
          <div className="mt-4 px-5 pb-5 space-y-4">
            ...
            <div className="mt-2.5 mb-5 flex items-center">
              <span className="mr-2 rounded bg-orange-500 px-2.5 py-0.5 text-xs font-semibold text-white">
                5.0
              </span>
              <svg
                aria-hidden="true"
