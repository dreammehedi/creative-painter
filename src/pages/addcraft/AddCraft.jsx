...
function AddCraft() {
  ...
  return (
    <>
      ...
      <section className="dark:bg-gray-900 dark:border-t dark:border-gray-800">
        <div className="container  py-4 md:py-6 lg:py-8 rounded-lg">
          <h1 className="mb-6 dark:text-white text-2xl md:text-3xl font-bold text-center text-orange-900">
            Add New Craft
          </h1>
          <form
            onSubmit={handleAddItem}
            className="w-full lg:max-w-4xl lg:mx-auto ring-1 ring-orange-500/50 p-4 md:p-6 lg:p-8 py-4 md:py-6 lg:py-8  rounded-lg grid grid-cols-6 justify-between gap-4 md:gap-6"
          >
            <div className="col-span-6 lg:col-span-3 space-y-1 text-base font-medium">
              ...
              <input
                ...
                className="w-full px-4 py-3 rounded-md ring-1 ring-orange-900 bg-gray-50 text-gray-800 dark:bg-gray-800 dark:text-gray-50 focus:ring-orange-500 outline-none  focus:shadow"
              />
            </div>
            ...
            <div className="col-span-6 space-y-1 text-base font-medium">
              ...
              {/* price */}
              <CurrencyInput
                className="col-span-6 lg:col-span-1  w-full px-4 py-3 rounded-md ring-1 ring-orange-900 bg-gray-50 text-gray-800 dark:bg-gray-800 dark:text-gray-50 focus:ring-orange-500 outline-none  focus:shadow"
                id="price"
                name="price"
                placeholder="$ Price..."
                decimalsLimit={2}
            ...
            <div className="col-span-6  space-y-1 text-base font-medium grid grid-cols-3 gap-4 md:gap-6 items-center justify-between">
              ...
              <div className="col-span-6 lg:col-span-1  space-y-1 flex flex-col items-start text-base font-medium">
                ...
                <div className="rating w-full px-4 py-3 rounded-md ring-1 ring-orange-900 bg-gray-50 text-gray-800 dark:bg-gray-800 dark:text-gray-50 focus:ring-orange-500 outline-none  focus:shadow">
            ...
            <button className="col-span-6 w-full p-3 text-center rounded-md text-gray-50 bg-orange-500 dark:bg-orange-500/50 dark:hover:bg-orange-500 font-poppins font-medium hover:bg-orange-500/50">
              Add
            </button>
          </form>
        </div>
